<template>
  <div
    class="min-h-screen text-white bg-gradient-to-br flex flex-col justify-center py-12 sm:px-6 lg:px-8"
  >
      ...
      <div class="text-white py-8 px-4 shadow-md rounded-lg sm:px-10">
        ...
        <form @submit.prevent="handleSignUp" class="space-y-6 bg-gray-700">
          <div>
            ...
            <div class="mt-1">
              <input
                ...
                required
                :disabled="isLoading"
                class="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-blue-500 focus:border-blue-500 transition-all disabled:bg-gray-100 disabled:cursor-not-allowed"
          ...
          <div>
            ...
            <p class="mt-1 text-xs">Minimal 8 karakter.</p>
          </div>
